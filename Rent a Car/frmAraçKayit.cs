...
{
    public partial class frmAraçKayit : Form
    {
        ...
        private void frmAraçKayit_Load(object sender, EventArgs e)
        {
        ...
        private void btn_kaydet_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                komut2.Parameters.AddWithValue("@kiraucreti", int.Parse(txtÜcret.Text));
